...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f05a22bfba31599, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f05a22bfba31599, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "developer.developer.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "developer.developer.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("developer/developer/tx.proto", fileDescriptor_0f05a22bfba31599) }

var fileDescriptor_0f05a22bfba31599 = []byte{
	// 318 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0x49, 0x2d, 0x4b,
	0xcd, 0xc9, 0x2f, 0x48, 0x2d, 0xd2, 0x47, 0xb0, 0x4a, 0x2a, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2,
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x0e, 0xcd, 0x78, 0xd7, 0x44, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/developer.developer.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/developer.developer.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "developer.developer.Msg",
	...
	Metadata: "developer/developer/tx.proto",
}
